...
package com.color.home.network.wifi;
...
public final class WifiConfigManager extends AsyncTask<WifiParsedResult, Object, Object> {
    ...
    protected Object doInBackground(WifiParsedResult... args) {
        ...
        AppController.getInstance().reportInternetLog(LOG_TYPE_WIFI_CONFIGURED,  AppController.getInstance().getString(R.string.ethernet_configured), 6, "", theWifiResult.getSsid(),
