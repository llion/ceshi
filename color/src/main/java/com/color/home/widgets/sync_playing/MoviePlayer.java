...
//            if(System.currentTimeMillis() < lastSystemMillis || (System.currentTimeMillis() - lastSystemMillis) > 60000){
//                Log.d(TAG, "time goes backward or be reset to somewhere distant now, restart playback ");
//                long offsetOnTimeChange = (System.currentTimeMillis() * 1000 - BENCHMARK_TIMES) % mDuration;
//                extractor.seekTo(offsetOnTimeChange, MediaExtractor.SEEK_TO_NEXT_SYNC);
//                if(VERBOSE)
//                    Log.d(TAG, "offset onTimeChange : " + offsetOnTimeChange + " , sampleTime : " + extractor.getSampleTime());
//
//            }
...
//                    long benchmarkTimeUs = c.getTimeInMillis()*1000;
//                    if(VERBOSE)
//                        Log.d(TAG, "benchMark:" + benchmarkTimeUs);
                    // Roughly calibrate in microSecond before playing


//                    if(VERBOSE)
//                        Log.d(TAG, ", SystemMilli : " + System.currentTimeMillis()*1000
//                                + " , PresentationTime=" + mBufferInfo.presentationTimeUs  + ", offsetUsec=" + offsetUsec);
                    if (doRender && frameCallback != null) {
                        frameCallback.preRender(mBufferInfo.presentationTimeUs, mDuration, extractor);
                    }
