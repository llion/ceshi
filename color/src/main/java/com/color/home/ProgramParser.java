...
public class ProgramParser {
    ...
    public static class Item implements ResourceCollectable {
        ...
        public Item(String id, String name, String type, String version, String backcolor, String alhpa, String duration,
                    String beglaring, String isNeedUpdate, String updateInterval, String playTimes, EffectType effect, Effect ineffect, Effect outeffect, MultiPicInfo multipicinfo,
                    String beToEndTime, String style, String isMultiLine, String moveType, String remainTime, String prefix, String endDateTime, String showFormat, String sourceType,
        ...
        public HashCode getTextBitmapHash(String text) {
            ...
            hashCode = Hashing.sha1().hashString(sb.toString(), Charset.forName("UTF-16"));
            if (DBG) {
                Log.d(TAG, "getTextBitmapHash. [sb=" + sb.toString() + ", mHash=" + mHash
                        + ", textColor = " + textColor + ", beglaring = " + beglaring);
            }
    ...
    public static class VideoItem extends Item {
        ...
        public VideoItem(String id, String name, String type, String version, String backcolor, String alhpa, String duration, String beglaring, String isNeedUpdate, String updateInterval, String playTimes, EffectType effect, Effect ineffect, Effect outeffect, MultiPicInfo multipicinfo, String beToEndTime, String style, String isMultiLine, String moveType, String remainTime, String prefix, String endDateTime, String showFormat, String sourceType, LogFont logfont, String text, String textColor, String isShowDayCount, String dayCountColor, String isShowHourCount, String hourCountColor,
            ...
            super(id, name, type, version, backcolor, alhpa, duration, beglaring, isNeedUpdate, updateInterval, playTimes, effect, ineffect, outeffect, multipicinfo, beToEndTime, style,
                    isMultiLine, moveType, remainTime, prefix, endDateTime, showFormat, sourceType, logfont, text, textColor, isShowDayCount, dayCountColor, isShowHourCount, hourCountColor,
    ...
    private Item readItem(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            } else if (tagName.equalsIgnoreCase("IsNeedUpdate")) {
                isNeedUpdate = readText(parser);
            }else if (tagName.equalsIgnoreCase("UpdateInterval")) {
                updateInterval = readText(parser);
            ...
            } else if (tagName.equalsIgnoreCase("PlayTimes")) {
                playTimes = readText(parser);
            ...
            } else if (tagName.equalsIgnoreCase("MoveType")) {
                moveType = readText(parser);
            } else if (tagName.equalsIgnoreCase("RemainTime")) {
                remainTime = readText(parser);
        ...
        if ("3".equals(type)) {
            return new VideoItem(id, name, type, version, backcolor, alhpa, duration, beglaring, isNeedUpdate, updateInterval, playTimes, effect, ineffect, outeffect, multipicinfo, beToEndTime, style,
                    isMultiLine, moveType, remainTime, prefix, endDateTime, showFormat, sourceType, logfont, text, textColor, isShowDayCount, dayCountColor, isShowHourCount, hourCountColor,
            ...
            return new Item(id, name, type, version, backcolor, alhpa, duration, beglaring, isNeedUpdate, updateInterval, playTimes, effect, ineffect, outeffect, multipicinfo, beToEndTime, style,
                    isMultiLine, moveType, remainTime, prefix, endDateTime, showFormat, sourceType, logfont, text, textColor, isShowDayCount, dayCountColor, isShowHourCount, hourCountColor,
                    isShowMinuteCount, minuteCountColor, isShowSecondCount, secondCountColor, width, height, filesource, reserveAS, isfromfile, isscroll, speed,
                    isheadconnecttail, wordspacing, repeatcount, isscrollbytime, movedir, length, videoWidth, videoHeight, inOffset, playLength, volume, showx, showy, loop,
                    showwidth, showheight, issetshowregion, issetplaylen, ifspeedbyframe, speedbyframe, url, centeralalign, regionname, weatherprefix, isshowweather, temperatureprefix,
