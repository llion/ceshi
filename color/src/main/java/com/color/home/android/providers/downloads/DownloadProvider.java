...
import com.color.home.android.providers.downloads.CLDownloadManager.Request;
...
public final class DownloadProvider extends ContentProvider {
    ...
    /** Database filename */
    private static final String DB_NAME = "color_downloads.db";
    /** Current database version */
    private static final int DB_VERSION = 109;
    /** Name of table in the database */
    private static final String DB_TABLE = "color_downloads";

    /** MIME type for the entire download list */
    private static final String DOWNLOAD_LIST_TYPE = "vnd.color_android.cursor.dir/download";
    /** MIME type for an individual download */
    private static final String DOWNLOAD_TYPE = "vnd.color_android.cursor.item/download";

    /** URI matcher used to recognize URIs sent by applications */
    private static final UriMatcher sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    /**
     * URI matcher constant for the URI of all color_downloads belonging to the
     * calling UID
     */
    ...
    /** URI matcher constant for the URI of all color_downloads in the system */
    ...
    static {
        sURIMatcher.addURI("color_downloads", "my_downloads", MY_DOWNLOADS);
        sURIMatcher.addURI("color_downloads", "my_downloads/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("color_downloads", "all_downloads", ALL_DOWNLOADS);
        sURIMatcher.addURI("color_downloads", "all_downloads/#", ALL_DOWNLOADS_ID);
        sURIMatcher.addURI("color_downloads", "my_downloads/#/" + Downloads.Impl.RequestHeaders.URI_SEGMENT, REQUEST_HEADERS_URI);
        sURIMatcher.addURI("color_downloads", "all_downloads/#/" + Downloads.Impl.RequestHeaders.URI_SEGMENT, REQUEST_HEADERS_URI);
        // temporary, for backwards compatibility
        sURIMatcher.addURI("color_downloads", "download", MY_DOWNLOADS);
        sURIMatcher.addURI("color_downloads", "download/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("color_downloads", "download/#/" + Downloads.Impl.RequestHeaders.URI_SEGMENT, REQUEST_HEADERS_URI);
        sURIMatcher.addURI("color_downloads", Downloads.Impl.PUBLICLY_ACCESSIBLE_DOWNLOADS_URI_SEGMENT + "/#", PUBLIC_DOWNLOAD_ID);
    }

    /** Different base URIs that could be used to access an individual download */
    private static final Uri[] BASE_URIS = new Uri[] { Downloads.Impl.CONTENT_URI, Downloads.Impl.ALL_DOWNLOADS_CONTENT_URI, };

    private static final String[] sAppReadableColumnsArray = new String[] { Downloads.Impl._ID, Downloads.Impl.COLUMN_APP_DATA,
            Downloads.Impl._DATA, Downloads.Impl.COLUMN_MIME_TYPE, Downloads.Impl.COLUMN_VISIBILITY, Downloads.Impl.COLUMN_DESTINATION,
            Downloads.Impl.COLUMN_CONTROL, Downloads.Impl.COLUMN_STATUS, Downloads.Impl.COLUMN_LAST_MODIFICATION,
            Downloads.Impl.COLUMN_NOTIFICATION_PACKAGE, Downloads.Impl.COLUMN_NOTIFICATION_CLASS, Downloads.Impl.COLUMN_TOTAL_BYTES,
            Downloads.Impl.COLUMN_CURRENT_BYTES, Downloads.Impl.COLUMN_TITLE, Downloads.Impl.COLUMN_DESCRIPTION, Downloads.Impl.COLUMN_URI,
            Downloads.Impl.COLUMN_IS_VISIBLE_IN_DOWNLOADS_UI, Downloads.Impl.COLUMN_FILE_NAME_HINT,
            Downloads.Impl.COLUMN_MEDIAPROVIDER_URI, Downloads.Impl.COLUMN_DELETED, "etag", OpenableColumns.DISPLAY_NAME,
    ...
    private static final List<String> downloadManagerColumnsList = Arrays.asList(CLDownloadManager.UNDERLYING_COLUMNS);
    ...
    private final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            ...
            case 102:
                addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_IS_PUBLIC_API, "INTEGER NOT NULL DEFAULT 0");
        ...
        private void createDownloadsTable(SQLiteDatabase db) {
            try {
                ...
                db.execSQL("CREATE TABLE " + DB_TABLE + "(" + Downloads.Impl._ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                        + Downloads.Impl.COLUMN_URI + " TEXT, " + Constants.RETRY_AFTER_X_REDIRECT_COUNT + " INTEGER, "
                        + Downloads.Impl.COLUMN_APP_DATA + " TEXT, " + Downloads.Impl.COLUMN_NO_INTEGRITY + " BOOLEAN, "
                        + Downloads.Impl.COLUMN_FILE_NAME_HINT + " TEXT, " + Constants.OTA_UPDATE + " BOOLEAN, " + Downloads.Impl._DATA
                        + " TEXT, " + Downloads.Impl.COLUMN_MIME_TYPE + " TEXT, " + Downloads.Impl.COLUMN_DESTINATION + " INTEGER, "
                        + Constants.NO_SYSTEM_FILES + " BOOLEAN, " + Downloads.Impl.COLUMN_VISIBILITY + " INTEGER, "
                        + Downloads.Impl.COLUMN_CONTROL + " INTEGER, " + Downloads.Impl.COLUMN_STATUS + " INTEGER, "
                        + Downloads.Impl.COLUMN_FAILED_CONNECTIONS + " INTEGER, " + Downloads.Impl.COLUMN_LAST_MODIFICATION + " BIGINT, "
                        + Downloads.Impl.COLUMN_NOTIFICATION_PACKAGE + " TEXT, " + Downloads.Impl.COLUMN_NOTIFICATION_CLASS + " TEXT, "
                        + Downloads.Impl.COLUMN_NOTIFICATION_EXTRAS + " TEXT, " + Downloads.Impl.COLUMN_COOKIE_DATA + " TEXT, "
                        + Downloads.Impl.COLUMN_USER_AGENT + " TEXT, " + Downloads.Impl.COLUMN_REFERER + " TEXT, "
                        + Downloads.Impl.COLUMN_TOTAL_BYTES + " INTEGER, " + Downloads.Impl.COLUMN_CURRENT_BYTES + " INTEGER, "
                        + Constants.ETAG + " TEXT, " + Constants.UID + " INTEGER, " + Downloads.Impl.COLUMN_OTHER_UID + " INTEGER, "
                        + Downloads.Impl.COLUMN_TITLE + " TEXT, " + Downloads.Impl.COLUMN_DESCRIPTION + " TEXT, " + Constants.MEDIA_SCANNED
                        + " BOOLEAN);");
        ...
        private void createHeadersTable(SQLiteDatabase db) {
            ...
            db.execSQL("CREATE TABLE " + Downloads.Impl.RequestHeaders.HEADERS_DB_TABLE + "(" + "id INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + Downloads.Impl.RequestHeaders.COLUMN_DOWNLOAD_ID + " INTEGER NOT NULL," + Downloads.Impl.RequestHeaders.COLUMN_HEADER
                    + " TEXT NOT NULL," + Downloads.Impl.RequestHeaders.COLUMN_VALUE + " TEXT NOT NULL" + ");");
        }
    }
    ...
    public boolean onCreate() {
        ...
        // "Could not get ApplicationInfo for com.android.defconatiner", e);
        // }
        // if (appInfo != null) {
        ...
        mDownloadsDataDir = CLStorageManager.getDownloadDataDirectory(getContext());
        // try {
    ...
    public String getType(final Uri uri) {
        ...
        case PUBLIC_DOWNLOAD_ID: {
            ...
            final String mimeType = DatabaseUtils.stringForQuery(db, "SELECT " + Downloads.Impl.COLUMN_MIME_TYPE + " FROM " + DB_TABLE
                    + " WHERE " + Downloads.Impl._ID + " = ?", new String[] { id });
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        boolean isPublicApi = values.getAsBoolean(Downloads.Impl.COLUMN_IS_PUBLIC_API) == Boolean.TRUE;
        ...
        if (dest != null) {
            if (getContext().checkCallingPermission(Downloads.Impl.PERMISSION_ACCESS_ADVANCED) != PackageManager.PERMISSION_GRANTED
                    && (dest == Downloads.Impl.DESTINATION_CACHE_PARTITION || dest == Downloads.Impl.DESTINATION_CACHE_PARTITION_NOROAMING || dest == Downloads.Impl.DESTINATION_SYSTEMCACHE_PARTITION)) {
            ...
            boolean hasNonPurgeablePermission = getContext().checkCallingPermission(Downloads.Impl.PERMISSION_CACHE_NON_PURGEABLE) == PackageManager.PERMISSION_GRANTED;
            if (isPublicApi && dest == Downloads.Impl.DESTINATION_CACHE_PARTITION_PURGEABLE && hasNonPurgeablePermission) {
                dest = Downloads.Impl.DESTINATION_CACHE_PARTITION;
            }
            if (dest == Downloads.Impl.DESTINATION_FILE_URI) {
                getContext().enforcePermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Binder.getCallingPid(),
                        Binder.getCallingUid(), "need WRITE_EXTERNAL_STORAGE permission to use DESTINATION_FILE_URI");
        ...
        if (Constants.LOGVV) {
            ...
            if (filteredValues.containsKey(Downloads.Impl.COLUMN_OTHER_UID)) {
                Log.v(Constants.TAG, "other UID " + filteredValues.getAsInteger(Downloads.Impl.COLUMN_OTHER_UID));
            }
        }
...
//        }
    ...
    private void checkInsertPermissions(ContentValues values) {
        ...
        enforceAllowedValues(values, Downloads.Impl.COLUMN_DESTINATION, Downloads.Impl.DESTINATION_CACHE_PARTITION_PURGEABLE,
                Downloads.Impl.DESTINATION_FILE_URI, Downloads.Impl.DESTINATION_NON_DOWNLOADMANAGER_DOWNLOAD);

        if (getContext().checkCallingOrSelfPermission(Downloads.Impl.PERMISSION_NO_NOTIFICATION) == PackageManager.PERMISSION_GRANTED) {
            enforceAllowedValues(values, Downloads.Impl.COLUMN_VISIBILITY, Request.VISIBILITY_HIDDEN, Request.VISIBILITY_VISIBLE,
                    Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED, Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION);
        } else {
            enforceAllowedValues(values, Downloads.Impl.COLUMN_VISIBILITY, Request.VISIBILITY_VISIBLE,
                    Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED, Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION);
        }

        // remove the rest of the columns that are allowed (with any value)
        values.remove(Downloads.Impl.COLUMN_URI);
        values.remove(Downloads.Impl.COLUMN_REFERER);
...
//        Helpers.validateSelection(selection, sAppReadableColumnsSet);
    ...
    private void logVerboseQueryInfo(String[] projection, final String selection, final String[] selectionArgs, final String sort,
            SQLiteDatabase db) {
    ...
    private Cursor queryRequestHeaders(SQLiteDatabase db, Uri uri) {
        ...
        String[] projection = new String[] { Downloads.Impl.RequestHeaders.COLUMN_HEADER, Downloads.Impl.RequestHeaders.COLUMN_VALUE };
    ...
    public int update(final Uri uri, final ContentValues values, final String where, final String[] whereArgs) {
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
            ...
            boolean isUserBypassingSizeLimit = values.containsKey(Downloads.Impl.COLUMN_BYPASS_RECOMMENDED_SIZE_LIMIT);
        ...
        case ALL_DOWNLOADS_ID:
            ...
            if (DBG)
                Log.i(TAG, "update. selection=" + selection.getSelection() + ", parameters=" + selection.getParameters().length
                        + ", first para=" + selection.getParameters()[0]);
    ...
    private SqlSelection getWhereClause(final Uri uri, final String where, final String[] whereArgs, int uriMatch) {
        ...
        if ((uriMatch == MY_DOWNLOADS || uriMatch == MY_DOWNLOADS_ID)
                && getContext().checkCallingPermission(Downloads.Impl.PERMISSION_ACCESS_ALL) != PackageManager.PERMISSION_GRANTED) {
            selection.appendClause(Constants.UID + "= ? OR " + Downloads.Impl.COLUMN_OTHER_UID + "= ?", Binder.getCallingUid(),
    ...
    public int delete(final Uri uri, final String where, final String[] whereArgs) {
        ...
        case ALL_DOWNLOADS_ID:
            ...
            final Cursor cursor = db.query(DB_TABLE, new String[] { Downloads.Impl._ID }, selection.getSelection(),
    ...
    // }
    //
    // final Cursor cursor = query(uri, new String[] { Downloads.Impl._DATA },
    // null, null, null);
    // String path;
    // try {
    ...
    public void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        final Cursor cursor = db.query(DB_TABLE, null, Downloads.Impl.COLUMN_LAST_MODIFICATION + ">" + modifiedAfter, null, null, null,
