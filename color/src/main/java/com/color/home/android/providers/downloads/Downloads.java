...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
         ...
         */
        public static final Uri CONTENT_URI = Uri.parse("content://color_downloads/my_downloads");

        /**
         * The content URI for accessing all downloads across all UIDs (requires
         * the ACCESS_ALL_DOWNLOADS permission).
         */
        public static final Uri ALL_DOWNLOADS_CONTENT_URI = Uri.parse("content://color_downloads/all_downloads");
         ...
         */
        public static final Uri PUBLICLY_ACCESSIBLE_DOWNLOADS_URI = Uri.parse("content://color_downloads/"
         ...
         */
        public static final String ACTION_DOWNLOAD_COMPLETED = "color.android.intent.action.DOWNLOAD_COMPLETED";
         ...
         */
        public static final String ACTION_NOTIFICATION_CLICKED = "color.android.intent.action.DOWNLOAD_NOTIFICATION_CLICKED";
         ...
         * 
         * @param visibility
         *            the value of {@link #COLUMN_VISIBILITY}.
        ...
        public static boolean isNotificationToBeDisplayed(int visibility) {
            return visibility == CLDownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED
                    || visibility == CLDownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION;
        }
         ...
         * it's in progress.
         */
        public static final int VISIBILITY_VISIBLE = CLDownloadManager.Request.VISIBILITY_VISIBLE;

        /**
         * This download is visible and shows in the notifications while in
         * progress and after completion.
         */
        public static final int VISIBILITY_VISIBLE_NOTIFY_COMPLETED = CLDownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;

        /**
         * This download doesn't show in the UI or in the notifications.
         */
        public static final int VISIBILITY_HIDDEN = CLDownloadManager.Request.VISIBILITY_HIDDEN;
     ...
     */
    private static final String QUERY_WHERE_CLAUSE = Impl.COLUMN_NOTIFICATION_PACKAGE + "=? AND " + Impl.COLUMN_NOTIFICATION_CLASS + "=?";
    ...
    public static final void removeAllDownloadsByPackage(Context context, String notification_package, String notification_class) {
        context.getContentResolver()
                .delete(Impl.CONTENT_URI, QUERY_WHERE_CLAUSE, new String[] { notification_package, notification_class });
    }
}
