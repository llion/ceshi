...
public class DownloadNotifier {
    ...
    // private final LongSparseLongArray mDownloadSpeed = new
    // LongSparseLongArray();
    //
    // /**
    ...
    // */
    // @GuardedBy("mDownloadSpeed")
    // private final LongSparseLongArray mDownloadTouch = new
    // LongSparseLongArray();
    //
    ...
    // final Multimap<String, DownloadInfo> clustered =
    ...
    // final Uri uri = new
    // Uri.Builder().scheme("active-dl").appendPath(tag).build();
    ...
    // }
    //
    // private static CharSequence getDownloadTitle(Resources res, DownloadInfo
    // info) {
    ...
    // Log.d(TAG, "Download " + id + " speed " + mDownloadSpeed.valueAt(i) +
    // "bps, "
    // + delta + "ms ago");
    // }
    // }
    ...
    //
    // /**
    // * Build tag used for collapsing several {@link DownloadInfo} into a
    // single
    // * {@link Notification}.
    // */
    ...
    // }
    public void notifyDownloadSpeed(long mId, int i) {
