...
public class Constants {
    private static final boolean DBG_DOWNLOADS = false;

    /** Tag used for debugging/logging */
    public static final String TAG = "CLDownloadManager";
    ...
    static {
        ...
        final boolean includeModel = "REL".equals(Build.VERSION.CODENAME) && !TextUtils.isEmpty(Build.MODEL);
     ...
     */
    private static final boolean LOCAL_LOGV = DBG_DOWNLOADS;
    public static final boolean LOGV = DBG_DOWNLOADS;

    /** Enable super-verbose logging */
    private static final boolean LOCAL_LOGVV = DBG_DOWNLOADS;
    public static final boolean LOGVV = DBG_DOWNLOADS;
